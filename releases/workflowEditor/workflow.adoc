...
*Caution!* For both converters you need to configure the pattern parameter (displayed in the right column): for the _Tika Multi-Format Reader_, set the pattern to "\**/*.*" and for _PDFReader_, set the pattern to "\**/*.pdf".
--
